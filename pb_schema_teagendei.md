...
[
  {
    ...
    "createRule": "",
    "updateRule": "id = @request.auth.id || @request.auth.role = 'dono'",
  ...
  },
  {
    ...
    "indexes": [],
    "listRule": "shop_id.company_id.owner_id = @request.auth.id",
    "viewRule": "shop_id.company_id.owner_id = @request.auth.id",
    "createRule": "shop_id.company_id.owner_id = @request.auth.id",
